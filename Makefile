...
BASE_OBJS = $(BASEDIR)/TWBaseScript.o $(BASEDIR)/TWBaseTrap.o $(BASEDIR)/TWBaseTrigger.o $(BASEDIR)/SavedCounter.o $(BASEDIR)/QVarVariable.o
...
$(BASEDIR)/QVarVariable.o: $(BASEDIR)/QVarVariable.cpp $(BASEDIR)/QVarVariable.h
